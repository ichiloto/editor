...
These rules intentionally repeat the repository-level rules so editor work cannot drift into local-only shortcuts.
...
Persist the selected stable reference after selection. Do not make authors remember or spell resource ids by hand.
